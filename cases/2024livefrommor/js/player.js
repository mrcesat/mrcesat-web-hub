...
const slides = [
    { type: 'video', src: 'media/TeploteploMORPerformance20240516.mp4', poster: 'media/laska2024_(4).jpg' },
    ...
    renderSlides() {
        ...
        this.slides.forEach((slide, index) => {
            ...
            if (slide.type === 'image') {
                ...
                // ✅ Убираем muted по умолчанию, добавляем controls
                slideEl.innerHTML = `
                    <video loop playsinline ${slide.poster ? `poster="${slide.poster}"` : ''}>
    ...
    setupEventListeners() {
        ...
        if (soundToggle) {
            ...
            soundToggle.addEventListener('click', () => {
                ...
                this.slidesContainer.querySelectorAll('video').forEach(video => {
                    video.muted = isMuted;
                });
